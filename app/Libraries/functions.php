    ...
    class QRcdrFn
    {
        ...
        public static function validateUrl($url)
        {
            ...
            if (strlen($trim) >= 2) {
                ...
                return filter_var($url, FILTER_UNSAFE_RAW);
            }
            return false;
        ...
        public static function getLang()
        {
            ...
            $getlang = filter_input(INPUT_GET, "lang", FILTER_UNSAFE_RAW);
         ...
         */
        public static function deleteOldFiles($dir = 'qrcodes/', $age = 3600, $ext = 'png')
        {
            if (file_exists($dir)) {
                $ext = strlen($ext) ? '.'.$ext : '';
                $now = time();
         ...
         */
        public static function langMenu($type = 'menu', $class = 'langmenu')
        {
            $relative = $this->relativePath();
         ...
         */
        public static function hexdecColor($colorCode, $defaultcolor = '#000000')
        {
         ...
         * @return css rule
         */
        public static function setCss($selector = false, $attributes = array())
        {
            $print = '';
        ...
        {
            global $_CONFIG;
            $getlayout = filter_input(INPUT_GET, "layout", FILTER_UNSAFE_RAW);
            $_CONFIG['layout'] = $getlayout ? $getlayout : $this->getConfig('layout');
            $getsidebar = filter_input(INPUT_GET, "sidebar", FILTER_UNSAFE_RAW);
            $_CONFIG['sidebar'] = $getsidebar ? $getsidebar : $this->getConfig('sidebar');
            $getbtn = filter_input(INPUT_GET, "btn", FILTER_UNSAFE_RAW);
         ...
         * @return main color
         */
        public static function getMainColor($primary = false)
        {
            $maincolor = $primary ? $primary : $this->randomColor();
            $getcolor = filter_input(INPUT_GET, "color", FILTER_UNSAFE_RAW);
         ...
         * @return css output
         */
        public static function setMainColor($primary = false, $echo = true)
        {
            ...
            if ($maincolor) {
                ...
                $output .= $this->setCss('.navbar-nav a, .navbar-nav .nav-link, .navbar-toggler', array('color'=> $maintext));
                $output .= $this->setCss(
                ...
                $output .= $this->setCss(
                    'a.btn-primary:hover, .btn-primary:not(:disabled):not(.disabled):hover,.btn-primary:not(:disabled):not(.disabled):active,.btn-primary:not(:disabled):not(.disabled):focus,.btn-primary:not(:disabled):not(.disabled).active, .btn-primary:not(:disabled):not(.disabled):active, .show > .btn-primary.dropdown-toggle,.btn-outline-primary:hover,.btn-outline-primary:active,.btn-outline-primary:focus,.btn-outline-primary:not(:disabled):not(.disabled).active, .btn-outline-primary:not(:disabled):not(.disabled):active, .show > .btn-outline-primary.dropdown-toggle',
                    array(
         ...
         */
        public static function getBtcRates()
        {
         ...
         * @return load css
         */
        public static function loadQRcdrCSS($version = '')
        {
            $relative = $this->relativePath();
         ...
         * @return load scripts
         */
        public static function loadQRcdrJS($version = '')
        {
            $relative = $this->relativePath();
            $lang = $this->getLang();
            ...
            if ($this->getConfig('debug_mode')) {
                echo '<script type="text/javascript" src="'.$relative.'js/popper.js"></script>';
                ...
                echo '<script type="text/javascript" src="'.$relative.'js/bootbox.min.js"></script>';
         ...
         * @return plugins css
         */
        public static function loadPluginsCss($echo = true)
        {
            $relative = $this->relativePath();
            if (file_exists($relative.'plugins')) {
