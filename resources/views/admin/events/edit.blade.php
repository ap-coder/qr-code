    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.events.update", [$event->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('design_colors') ? 'is-invalid' : '' }}" name="design_colors_id" id="design_colors_id">
                    @foreach($design_colors as $id => $entry)
                        <option value="{{ $id }}" {{ (old('design_colors_id') ? old('design_colors_id') : $event->design_colors->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qr_name') ? 'is-invalid' : '' }}" type="text" name="qr_name" id="qr_name" value="{{ old('qr_name', $event->qr_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('organizer') ? 'is-invalid' : '' }}" type="text" name="organizer" id="organizer" value="{{ old('organizer', $event->organizer) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sub_title') ? 'is-invalid' : '' }}" type="text" name="sub_title" id="sub_title" value="{{ old('sub_title', $event->sub_title) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('summary') ? 'is-invalid' : '' }}" name="summary" id="summary">{!! old('summary', $event->summary) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('doortime') ? 'is-invalid' : '' }}" type="text" name="doortime" id="doortime" value="{{ old('doortime', $event->doortime) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('event_date_time') ? 'is-invalid' : '' }}" type="text" name="event_date_time" id="event_date_time" value="{{ old('event_date_time', $event->event_date_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $event->end_date) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('all_day') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="all_day" id="all_day" value="1" {{ $event->all_day || old('all_day', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('signup_deadline') ? 'is-invalid' : '' }}" type="text" name="signup_deadline" id="signup_deadline" value="{{ old('signup_deadline', $event->signup_deadline) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_1') ? 'is-invalid' : '' }}" type="text" name="link_1" id="link_1" value="{{ old('link_1', $event->link_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_1_text') ? 'is-invalid' : '' }}" type="text" name="link_1_text" id="link_1_text" value="{{ old('link_1_text', $event->link_1_text) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_2') ? 'is-invalid' : '' }}" type="text" name="link_2" id="link_2" value="{{ old('link_2', $event->link_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_2_text') ? 'is-invalid' : '' }}" type="text" name="link_2_text" id="link_2_text" value="{{ old('link_2_text', $event->link_2_text) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('button_text') ? 'is-invalid' : '' }}" type="text" name="button_text" id="button_text" value="{{ old('button_text', $event->button_text) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('button_link') ? 'is-invalid' : '' }}" type="text" name="button_link" id="button_link" value="{{ old('button_link', $event->button_link) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('button_icon_class') ? 'is-invalid' : '' }}" type="text" name="button_icon_class" id="button_icon_class" value="{{ old('button_icon_class', $event->button_icon_class) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('venue_name') ? 'is-invalid' : '' }}" type="text" name="venue_name" id="venue_name" value="{{ old('venue_name', $event->venue_name) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('venue_address') ? 'is-invalid' : '' }}" name="venue_address_id" id="venue_address_id">
                    @foreach($venue_addresses as $id => $entry)
                        <option value="{{ $id }}" {{ (old('venue_address_id') ? old('venue_address_id') : $event->venue_address->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('about') ? 'is-invalid' : '' }}" name="about" id="about">{!! old('about', $event->about) !!}</textarea>
                @if($errors->has('about'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact') ? 'is-invalid' : '' }}" type="text" name="contact" id="contact" value="{{ old('contact', $event->contact) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $event->phone) }}">
                @if($errors->has('phone'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $event->email) }}">
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}" type="text" name="website" id="website" value="{{ old('website', $event->website) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $event->slug) }}">
                @if($errors->has('slug'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{{ old('notes', $event->notes) }}</textarea>
                @if($errors->has('notes'))
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('add_share_button') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="add_share_button" id="add_share_button" value="1" {{ $event->add_share_button || old('add_share_button', 0) === 1 ? 'checked' : '' }}>
