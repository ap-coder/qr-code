...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.designColor.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.design-colors.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="primary">{{ trans('cruds.designColor.fields.primary') }}</label>
                <input class="form-control {{ $errors->has('primary') ? 'is-invalid' : '' }}" type="text" name="primary" id="primary" value="{{ old('primary', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('secondary') ? 'is-invalid' : '' }}" type="text" name="secondary" id="secondary" value="{{ old('secondary', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gradient') ? 'is-invalid' : '' }}" type="text" name="gradient" id="gradient" value="{{ old('gradient', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('custom_color') ? 'is-invalid' : '' }}" type="text" name="custom_color" id="custom_color" value="{{ old('custom_color', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('custom_button') ? 'is-invalid' : '' }}" type="text" name="custom_button" id="custom_button" value="{{ old('custom_button', '') }}">
