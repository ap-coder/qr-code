    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.qr-codes.update", [$qrCode->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $qrCode->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $qrCode->description) !!}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('published') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="published" id="published" value="1" {{ $qrCode->published || old('published', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $qrCode->slug) }}">
                @if($errors->has('slug'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('scans') ? 'is-invalid' : '' }}" type="number" name="scans" id="scans" value="{{ old('scans', $qrCode->scans) }}" step="1">
                @if($errors->has('scans'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('clicks') ? 'is-invalid' : '' }}" type="number" name="clicks" id="clicks" value="{{ old('clicks', $qrCode->clicks) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('short_link') ? 'is-invalid' : '' }}" type="text" name="short_link" id="short_link" value="{{ old('short_link', $qrCode->short_link) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ $qrCode->active || old('active', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('pause') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="pause" id="pause" value="1" {{ $qrCode->pause || old('pause', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('types') ? 'is-invalid' : '' }}" name="types[]" id="types" multiple>
                    @foreach($types as $id => $type)
                        <option value="{{ $id }}" {{ (in_array($id, old('types', [])) || $qrCode->types->contains($id)) ? 'selected' : '' }}>{{ $type }}</option>
                    @endforeach
                </select>
                @if($errors->has('types'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('vcards') ? 'is-invalid' : '' }}" name="vcards[]" id="vcards" multiple>
                    @foreach($vcards as $id => $vcard)
                        <option value="{{ $id }}" {{ (in_array($id, old('vcards', [])) || $qrCode->vcards->contains($id)) ? 'selected' : '' }}>{{ $vcard }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('websites') ? 'is-invalid' : '' }}" name="websites[]" id="websites" multiple>
                    @foreach($websites as $id => $website)
                        <option value="{{ $id }}" {{ (in_array($id, old('websites', [])) || $qrCode->websites->contains($id)) ? 'selected' : '' }}>{{ $website }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('business_pages') ? 'is-invalid' : '' }}" name="business_pages[]" id="business_pages" multiple>
                    @foreach($business_pages as $id => $business_page)
                        <option value="{{ $id }}" {{ (in_array($id, old('business_pages', [])) || $qrCode->business_pages->contains($id)) ? 'selected' : '' }}>{{ $business_page }}</option>
                    @endforeach
                </select>
