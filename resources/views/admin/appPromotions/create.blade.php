...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.appPromotion.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.app-promotions.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('colors') ? 'is-invalid' : '' }}" name="colors_id" id="colors_id">
                    @foreach($colors as $id => $entry)
                        <option value="{{ $id }}" {{ old('colors_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('app_name') ? 'is-invalid' : '' }}" type="text" name="app_name" id="app_name" value="{{ old('app_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apple_store_link') ? 'is-invalid' : '' }}" type="text" name="apple_store_link" id="apple_store_link" value="{{ old('apple_store_link', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('google_play_link') ? 'is-invalid' : '' }}" type="text" name="google_play_link" id="google_play_link" value="{{ old('google_play_link', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amazon_app_link') ? 'is-invalid' : '' }}" type="text" name="amazon_app_link" id="amazon_app_link" value="{{ old('amazon_app_link', '') }}">
