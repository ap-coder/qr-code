    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.socials.update", [$social->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $social->title) }}">
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('social_name') ? 'is-invalid' : '' }}" type="text" name="social_name" id="social_name" value="{{ old('social_name', $social->social_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" type="text" name="url" id="url" value="{{ old('url', $social->url) }}">
                @if($errors->has('url'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('channel_name') ? 'is-invalid' : '' }}" type="text" name="channel_name" id="channel_name" value="{{ old('channel_name', $social->channel_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('icon_class') ? 'is-invalid' : '' }}" type="text" name="icon_class" id="icon_class" value="{{ old('icon_class', $social->icon_class) }}">
