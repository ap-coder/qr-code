            ...
            <div class="row form-input-row formly-field">
                ...
                <div class="row col-md-12 mb-10">
                    ...
                    <div class="col-sm-12 col-md-6 box-input">
                        <div class="businesswelcomecroppreviewimage">
                            <img src="{{ asset('site/img/qr_code.jpg') }}">
                            {{-- <span class="fas fa-edit"></span> --}}
                        </div>
                        <img class="businesswelcomeImage" src="{{ asset('site/img/welcome.png') }}">
                        <input type="file" id="business_welcome_image" style="display: none;" />
                    </div>
                    <div class="col-sm-12 col-md-3 box-input">
                       <button type="button" class="btn btn-danger changebusinesswelcomeImage"> <i class="fa fa-sync"></i> Change</button>
                    </div>
...
<input type="hidden" name="businesswelcomeLogo" id="businesswelcomeLogo">

<div class="modal fade" id="business_welcome_modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="img-container">
                    <div class="row">
                        <div class="col-md-8">
                            <img id="businesswelcomecropimage" src="">
                        </div>
                        <div class="col-md-4">
                            <div class="businesswelcomecroppreview"></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="businesswelcomecrop">Confirm</button>
            </div>
        </div>
    </div>
</div>
