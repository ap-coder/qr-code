<div class="row col-md-12 mb-10 channels-container pinterest-container" random="{{ $rand ?? 0 }}">
    ...
    <div class="col-sm-12 col-md-8 channel-input-container">
        <div class="input-group">
            ...
            <input type="text" class="form-control" placeholder="www.pinterest.com/username" required="required"
                id="channelInput-12" name="channelInput-12">
        </div>
        <div class="input-group">
            <span class="input-group-addon" id="label-addon12">Text</span>
            <input type="text" class="form-control" placeholder="Follow us" id="qr_media_channels_channels_12" name="qr_media_channels_channels_12">
        </div>
    </div>
