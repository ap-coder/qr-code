            ...
            <div class="row form-input-row formly-field">
                ...
                <div class="row col-md-12 mb-10">
                    ...
                    <div class="col-sm-12 col-md-6 box-input">
                        ...
                        <img class="welcomeImage" src="{{ asset('site/img/welcome.png') }}">
                        <input type="file" id="welcome_image" style="display: none;" />
                    </div>
                    <div class="col-sm-12 col-md-3 box-input">
                       <button type="button" class="btn btn-danger changeWelcomeImage"> <i class="fa fa-sync"></i> Change</button>
                    </div>
